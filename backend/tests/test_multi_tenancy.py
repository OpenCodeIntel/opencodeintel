...
REPOS_DB = [
    {
        ...
        "status": "indexed", "local_path": "/repos/1a", "file_count": 10
    },
    {
        "id": "repo-user1-b", "name": "User1 Repo B", "user_id": "user-1",
        "status": "indexed", "local_path": "/repos/1b", "file_count": 20
    },
    {
        "id": "repo-user2-a", "name": "User2 Repo A", "user_id": "user-2",
        "status": "indexed", "local_path": "/repos/2a", "file_count": 15
    },
    {
        "id": "repo-user2-b", "name": "User2 Repo B", "user_id": "user-2",
        "status": "indexed", "local_path": "/repos/2b", "file_count": 25
    },
]
...
class TestSecurityHelpers:
    ...
    def test_get_repo_or_404_raises_404_for_wrong_user(self):
        ...
        from dependencies import get_repo_or_404, repo_manager
        from fastapi import HTTPException

        with patch.object(repo_manager, 'get_repo_for_user', return_value=None):
    ...
    def test_get_repo_or_404_returns_repo_for_owner(self):
        ...
        with patch.object(repo_manager, 'get_repo_for_user', return_value=expected_repo):
    ...
    def test_verify_repo_access_raises_404_for_wrong_user(self):
        ...
        from dependencies import verify_repo_access, repo_manager
        from fastapi import HTTPException
...
class TestDevApiKeySecurity:
    ...
    def _reload_auth_module(self):
        """Helper to reload auth module with current env vars."""
        import importlib
