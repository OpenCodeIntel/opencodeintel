...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0b] text-white">
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto">
            ...
            Powered by semantic embeddings and AI.
          </p>
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${isSelected 
                      ? `bg-gradient-to-r ${repo.color} border-current text-white shadow-lg` 
          ...
          <div className="relative max-w-2xl mx-auto mb-6">
            ...
            <div className="relative bg-[#111113] rounded-2xl border border-white/10 p-3 shadow-2xl">
              <form onSubmit={(e) => { e.preventDefault(); handleSearch(); }} className="flex items-center gap-3">
                <div className="flex-1 flex items-center gap-3">
                  ...
                  <input
                    ...
                    placeholder="Search for authentication, error handling, API routes..."
                    className="flex-1 bg-transparent border-0 text-white placeholder:text-gray-500 focus:outline-none text-base py-3"
                    autoFocus
                  />
                </div>
                <Button
                  ...
                  className="px-6 py-3 h-auto bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-medium rounded-xl transition-all duration-200 disabled:opacity-50 shrink-0"
                >
                  {loading ? (
          ...
          <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-4 text-sm">
                ...
                {searchTime && (
                  <>
                    ...
                    <span className="text-gray-400">
                      <span className="font-mono text-green-400">{searchTime}ms</span>
                    </span>
                  </>
                )}
              </div>
            ...
            <div className="space-y-4">
              {results.map((result, idx) => (
                <Card 
                  key={idx}
                  className="bg-[#111113] border-white/5 overflow-hidden hover:border-white/10 transition-all duration-200"
                >
                  {/* Result Header */}
                  <div className="px-5 py-4 border-b border-white/5 flex items-start justify-between">
                    <div>
                      <div className="flex items-center gap-3">
                        <h3 className="font-mono font-semibold text-white">{result.name}</h3>
            ...
            {results.length === 0 && !loading && (
              <div className="text-center py-16">
                ...
                <p className="text-gray-500">Try a different query or select another repository</p>
              </div>
            )}
          </div>
        </section>
      ...
      {/* Features Preview (shown before search) */}
      {!hasSearched && (
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center p-6">
                ...
                <h3 className="font-semibold text-white mb-2">Semantic Search</h3>
              ...
              <div className="text-center p-6">
                ...
                <h3 className="font-semibold text-white mb-2">Code Intelligence</h3>
                <p className="text-sm text-gray-500">
      ...
      <footer className="py-8 px-6 border-t border-white/5">
        <div className="max-w-6xl mx-auto flex items-center justify-between text-sm text-gray-500">
          ...
          <div className="flex items-center gap-6">
            <a href="https://github.com/opencodeintel/opencodeintel" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
              GitHub
            </a>
            <span className="text-gray-700">•</span>
